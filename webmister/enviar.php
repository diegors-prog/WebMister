...
// Mudar Aqui o e-mail
$email_envio = "contato@webmister.com.br"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "Pitacera5276"; // Senha do e-mail

$site_name = "Webmister"; // Nome do Site
$site_url = "www.webmister.com.br"; // URL do Site

$host_smtp = "smtp-vip.kinghost.net."; // HOST SMTP Ex: smtp.domain.com.br
